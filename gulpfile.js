...
//PUG
    gulp.task('pug', function(){
        ...
        return gulp.src('front/pug/pages/*.pug')
            .pipe(plumber({
                errorHandler: notify.onError()
            }))
            .pipe(gulpIf(isDevelopment, sourcemaps.init()))
...
gulp.task('copyData', function(){
    return gulp.src('front/data/**/*.*', {since: gulp.lastRun('copyData')})
...
//BUILD
gulp.task('build', gulp.series('clean', gulp.parallel('pug', 'sass', 'js', 'copyFonts', 'copyImg', 'copyData', 'copyJson')));
//STATIC SERVER
...
gulp.task('watch', function(){
    ...
    gulp.watch('front/data/**/*.*', gulp.series('copyData'));
